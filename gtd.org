...
#+CAPTION: Clock summary at [2017-12-25 Mon 21:37], for week 2017-W52.
| File    | Headline                                    | Time   |      |
|---------+---------------------------------------------+--------+------|
|         | ALL *Total time*                            | *4:36* |      |
|---------+---------------------------------------------+--------+------|
...
|         | study                                       | 3:32   |      |
|         | \_  complete module of sensitivity analysis |        | 3:32 |
|         | life                                        | 1:04   |      |
|         | \_  watch TV series                         |        | 1:04 |
#+END:
...
#+CAPTION: Clock summary at [2017-12-25 Mon 21:37], for December 2017.
| File       | Headline                                     | Time       |       |
|------------+----------------------------------------------+------------+-------|
|            | ALL *Total time*                             | *2d 20:25* |       |
|------------+----------------------------------------------+------------+-------|
| career.org | *File time*                                  | *10:16*    |       |
|            | Learn Emacs                                  | 10:16      |       |
|            | \_  learn elisp                              |            | 10:16 |
|------------+----------------------------------------------+------------+-------|
| gtd.org    | *File time*                                  | *2d 9:50*  |       |
|            | study                                        | 1d 14:53   |       |
...
|            | \_  complete module of sensitivity analysis  |            | 20:04 |
|            | life                                         | 18:57      |       |
|            | \_  watch movies                             |            |  6:39 |
|            | \_  watch teleplay by Huge                   |            |  9:34 |
|            | \_  watch TV series                          |            |  2:44 |
|------------+----------------------------------------------+------------+-------|
