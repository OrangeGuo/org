...
#+CAPTION: Clock summary at [2017-12-12 Tue 22:03], for week 2017-W50.
| File | Headline         | Time   |
|------+------------------+--------|
|      | ALL *Total time* | *0:00* |
#+END:
...
#+CAPTION: Clock summary at [2017-12-12 Tue 22:03], for December 2017.
| File       | Headline                                     | Time    |      |
|------------+----------------------------------------------+---------+------|
|            | ALL *Total time*                             | *22:08* |      |
|------------+----------------------------------------------+---------+------|
| career.org | *File time*                                  | *5:12*  |      |
|            | Learn Emacs                                  | 5:12    |      |
|            | \_  learn elisp                              |         | 5:12 |
|------------+----------------------------------------------+---------+------|
| gtd.org    | *File time*                                  | *16:56* |      |
|            | Workspace                                    | 16:56   |      |
