...
#+CAPTION: Clock summary at [2017-12-24 Sun 09:45], for week 2017-W51.
| File       | Headline                                    | Time    |       |
|------------+---------------------------------------------+---------+-------|
|            | ALL *Total time*                            | *21:08* |       |
|------------+---------------------------------------------+---------+-------|
| career.org | *File time*                                 | *1:46*  |       |
|            | Learn Emacs                                 | 1:46    |       |
|            | \_  learn elisp                             |         |  1:46 |
|------------+---------------------------------------------+---------+-------|
| gtd.org    | *File time*                                 | *19:03* |       |
|            | study                                       | 16:40   |       |
|            | \_  type a essay for cet 6                  |         |  1:30 |
|            | \_  complete module of sensitivity analysis |         | 15:10 |
|            | life                                        | 2:23    |       |
|            | \_  watch movies                            |         |  2:23 |
|------------+---------------------------------------------+---------+-------|
...
#+CAPTION: Clock summary at [2017-12-24 Sun 09:46], for December 2017.
| File       | Headline                                     | Time       |       |
|------------+----------------------------------------------+------------+-------|
|            | ALL *Total time*                             | *2d 10:44* |       |
|------------+----------------------------------------------+------------+-------|
| career.org | *File time*                                  | *9:06*     |       |
|            | Learn Emacs                                  | 9:06       |       |
|            | \_  learn elisp                              |            |  9:06 |
|------------+----------------------------------------------+------------+-------|
| gtd.org    | *File time*                                  | *2d 1:19*  |       |
|            | study                                        | 1d 9:06    |       |
