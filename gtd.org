...
** LAST [#B] review compilation principle exam                        :exam:
...
#+CAPTION: Clock summary at [2018-01-13 Sat 20:42], for week 2018-W02.
| File      | Headline                                | Time    |      |
|-----------+-----------------------------------------+---------+------|
|           | ALL *Total time*                        | *21:29* |      |
|-----------+-----------------------------------------+---------+------|
| gtd.org   | *File time*                             | *20:50* |      |
|           | study                                   | 17:03   |      |
|           | \_  compilation principle lesson design |         | 8:14 |
|           | \_  review compilation principle exam   |         | 8:49 |
|           | life                                    | 3:47    |      |
|           | \_  watch TV series                     |         | 3:47 |
|-----------+-----------------------------------------+---------+------|
...
#+CAPTION: Clock summary at [2018-01-13 Sat 20:42], for January 2018.
| File       | Headline                                    | Time       |      |
|------------+---------------------------------------------+------------+------|
|            | ALL *Total time*                            | *1d 18:51* |      |
|------------+---------------------------------------------+------------+------|
| career.org | *File time*                                 | *0:23*     |      |
|            | Learn Emacs                                 | 0:23       |      |
|            | \_  learn elisp                             |            | 0:23 |
|------------+---------------------------------------------+------------+------|
| gtd.org    | *File time*                                 | *1d 17:49* |      |
|            | study                                       | 1d 12:08   |      |
